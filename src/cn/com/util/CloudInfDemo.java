...
public class CloudInfDemo {
	...
	//应用 app_key
	private final static String APP_KEY = "6pyIG3GhchyGiqmx6Rj5M0HwFO3vvZRo";
	//应用 app_secret
	private final static String APP_SECRET = "5w7inR3AhICrnGvUDIJAjLwioepq32SoUDHqCzyYYlZoYzKieLkpMnj5xHijcZ6k";
	//接口响应格式 json或xml
